...
class AppRepository(private val remoteAppDataSource: RemoteAppDataSource) : AppDataSource {
    ...
    override fun addComment(parent_post_id: String, user_id: String, content: String, callback: (Boolean) -> Unit) = remoteAppDataSource.addComment(parent_post_id, user_id, content, callback)
